...
public class HttpAsyncClientLiveTest {
    ...
    private static final String HOST_WITH_SSL = "https://vnexpress.net/";
    ...
    public void whenUseSSLWithHttpAsyncClient_thenCorrect() throws Exception {
        final TrustStrategy accetingTrustStrategy = (certificate, authType) -> true;
        final SSLContext sslContext = SSLContexts.custom().loadTrustMaterial(null, accetingTrustStrategy).build();
